function [result] = na_spectral_power(recording, window_size, time_bandwidth_product,number_tapers, bandpass, step_size)
    ...
    for i = 1:number_window
       ...
       [avg_spectrum,spectrum,timestamp,frequency,peak_frequency] = spectral_power(segment_data,sampling_rate, bandpass, time_bandwidth_product,number_tapers,window_size,step_size); 
       ...
       if (i == 1)
          ...
          result.data.peak_frequency = peak_frequency;
           ...
           result.data.timestamps = cat(2,result.data.timestamps,timestamp+step_size*(i-1));
