function [b_small_worldness] = undirected_weighted_small_worldness(matrix,null_networks)
...
%   null_networks: 3d matrix containing pre-made null_networks
    ...
    [~,~,~,norm_avg_path_length] = weighted_global_efficiency(matrix,null_networks);
