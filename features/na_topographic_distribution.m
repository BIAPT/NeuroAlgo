function [result] = na_topographic_distribution(recording, window_size, frequency, is_verbose)
    ...
    for i = 1:number_window
       print(strcat("Topographic Distribution at window: ",string(i)," of ", string(number_window)),is_verbose); 
