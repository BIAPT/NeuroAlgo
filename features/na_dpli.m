function [result] = na_dpli(recording, frequency_band, window_size, number_surrogate, p_value ,is_verbose)
    ...
    for i = 1:number_window
       print(strcat("dPLI at window: ",string(i)," of ", string(number_window)),is_verbose); 
